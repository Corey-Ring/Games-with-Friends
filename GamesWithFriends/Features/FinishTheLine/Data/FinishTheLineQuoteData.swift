...
enum FinishTheLineQuoteData {
    ...
    static let silverScreen: [Quote] = [
        ...
        Quote(id: "bm-2006-dynamite", setup: "Napoleon, give me some of your ___", fullLine: "Give me some of your tots", missingWord: "tots", alternates: ["tater tots"], source: "Napoleon Dynamite", category: .silverScreen, decade: .twoThousands, difficulty: .medium),
        ...
        Quote(id: "csm-1984-woman", setup: "I'll have what she's ___", fullLine: "I'll have what she's having", missingWord: "having", source: "When Harry Met Sally", category: .silverScreen, decade: .eighties, difficulty: .medium),
    ...
    static let animated: [Quote] = [
        ...
        Quote(id: "bm-1993-worries", setup: "It means no ___ for the rest of your days", fullLine: "It means no worries for the rest of your days", missingWord: "worries", alternates: ["no worries"], source: "The Lion King", category: .animated, decade: .nineties, difficulty: .easy, blankPosition: .middle),
